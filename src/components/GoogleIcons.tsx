    ...
    >
      ...
      <View
        style={{
          ...
          width: size * 0.9,
          height: size * 0.2,
          backgroundColor: GColor.magenta,
          borderRadius: size * 0.1,
        }}
      />
      <View
...
export function GalleryCardIcon({
  type,
  color,
  size = 44,
}: {
  ...
  return (
    ...
    >
      ...
      {type === 'models' && (
        <View
          style={{ width: 20, height: 16, justifyContent: 'space-between' }}
        >
...
export const FileTextIcon = ({ color = GColor.blue }: { color?: string }) => (
  ...
  >
    ...
    />
    <View
      style={{ width: 8, height: 1.5, backgroundColor: color, borderRadius: 1 }}
    />
    <View
      style={{ width: 6, height: 1.5, backgroundColor: color, borderRadius: 1 }}
    />
  </View>
);
...
const NAV_SELECTED = '#FFFFFF';
const NAV_UNSELECTED = '#8D95A3';
  ...
  >
    <View
      style={{
        ...
        borderWidth: 2,
        borderColor: active ? NAV_SELECTED : NAV_UNSELECTED,
        borderRadius: 6,
      }}
    />
    <View
      style={{
        width: 4,
        height: 4,
        backgroundColor: active ? NAV_SELECTED : NAV_UNSELECTED,
        borderRadius: 2,
        position: 'absolute',
      }}
    />
...
export const ToolsIcon = ({ active }: { active: boolean }) => {
  const color = active ? NAV_SELECTED : NAV_UNSELECTED;
  return (
    <View
      style={{
        width: 24,
